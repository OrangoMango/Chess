...
public class Board{
	...
	public String playerA = "WHITE", playerB = "BLACK";
	...
	public String getPGN(){
		...
		//Date date = new Date();
		builder.append("[Event \""+MainApplication.format("%s vs %s", this.playerA, this.playerB)+"\"]\n");
	...
	public String getFEN(){
		...
		builder.append(MainApplication.format("%s %d %d", this.enPassant == null ? "-" : this.enPassant, this.fifty, this.movesN));
	...
	public String getBoardInfo(){
		...
		return MainApplication.format("B:%d W:%d - BK:%s WK:%s - BCK:%s WCK:%s\nChecks: %s %s\n",
